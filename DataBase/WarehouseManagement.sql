...
CREATE TABLE Devices (
    ...
    device_name NVARCHAR(100) NOT NULL,   
		 VARCHAR(50) NOT NULL CHECK (device_type IN ('import', 'export', 'check')), 
...
-- Bảng Ghi Log thao tác
CREATE TABLE ActionLog (
    log_id INT IDENTITY(1,1) PRIMARY KEY,
    user_id VARCHAR(20), 
    action_type VARCHAR(10) NOT NULL CHECK (action_type IN ('INSERT', 'UPDATE', 'DELETE', 'BACKUP', 'RESTORE')),
