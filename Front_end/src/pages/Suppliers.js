...
function Supplier() {
  ...
  const handleDelete = async (supplier) => {
    ...
    if (window.confirm(`Bạn có chắc chắn muốn xóa nhà cung cấp: ${supplier.supplier_name}?`)) {
      try {
        ...
        toast.error("Xóa nhà cung cấp thất bại! Vui lòng thử lại sau.");
      }
    }
  };
  ...
  const handleAddSupplier = async () => {
    try {
      ...
      toast.error("Thêm nhà cung cấp thất bại! Vui lòng thử lại sau.");
      console.error(err);
    }
  };
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      toast.error("Cập nhật nhà cung cấp thất bại! Vui lòng thử lại sau.");
    }
  };
