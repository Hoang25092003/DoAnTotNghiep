                            ...
                            {loading ? (
                                ...
                                actionlog.map((row) => (
                                    <tr key={row.log_id}>
                                        ...
                                        <td>{row.action_type === "INSERT" ? "Thêm " : row.action_type === "UPDATE" ? "Cập nhật " : row.action_type === "DELETE" ? "Xóa " : row.action_type === "BACKUP" ? "Sao lưu " : "Khôi phục"}</td>
                            ...
                            <Form>
                                ...
                                <Row>
                                    <Col md={4}>
                                        <Form.Group className="mb-3">
                                            <Form.Label>Loại thao tác</Form.Label>
                                            <Form.Control type="text" value={selectedLog?.action_type === "INSERT" ? "Thêm " : selectedLog?.action_type === "UPDATE" ? "Cập nhật " : selectedLog?.action_type === "DELETE" ? "Xóa " : selectedLog?.action_type === "BACKUP" ? "Sao lưu " : "Khôi phục "} readOnly />
                                        </Form.Group>
                                    </Col>
                                    {
                                        selectedLog?.action_type === "BACKUP" || selectedLog?.action_type === "RESTORE" ? (
                                            <>
                                            <Col md={4}>
                                                    <Form.Group className="mb-3">
                                                        <Form.Label>Mô tả</Form.Label>
                                                        <Form.Control type="text" value={selectedLog?.description} readOnly />
                                                    </Form.Group>
                                                </Col>
                                                <Col md={4}>
                                                    <Form.Group className="mb-3">
                                                        <Form.Label>Tên File</Form.Label>
                                                        <Form.Control type="text" value={selectedLog?.new_data} readOnly />
                                                    </Form.Group>
                                                </Col>
                                            </>
                                        ) : (
